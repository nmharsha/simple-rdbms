...
int RBFTest_Update(RecordBasedFileManager *rbfm)
{
	...
	cout << "shortID: " << shortRID.slotNum << endl;
	// Insert mid record
	insertRecord(rbfm, rid, midstr);
	RID midRID = rid;
	cout << "rid: " << rid.slotNum << endl;
	cout << "midID: " << midRID.slotNum << endl;
