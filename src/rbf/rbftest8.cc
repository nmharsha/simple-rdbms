...
//    nullsIndicator[0] = 128;
    ...
    rbfm->readAttribute(fileHandle,recordDescriptor, rid, "Salary", readAttData);
    cout << endl;
    cout << "finished ratt" << endl;
	void *verify;
	verify = malloc(100);
	memcpy((char*)verify, (char*) readAttData + 1, sizeof(int));
	int offsetResult = *(int *) verify;
//	memcpy((char*)verify, (char*) readAttData + 5, offsetResult);
//	cout << "Value: " << (char*) verify << endl;
	free(verify);
	 cout << "Int:" << offsetResult;
    cout << endl;
